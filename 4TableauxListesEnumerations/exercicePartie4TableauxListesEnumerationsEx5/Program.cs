...
Console.WriteLine("Veuillez renseigner le type de tornade (entre 0 et 5)");
userTornado = int.Parse(Console.ReadLine());
Console.WriteLine(week[userTornado, 1]);